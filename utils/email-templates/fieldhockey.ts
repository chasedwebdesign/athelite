...
export const fieldHockeyTemplates: EmailTemplate[] = [
  ...
  },
  {
    ...
    body: `Coach,\n\nI am {{FIRST_NAME}} {{LAST_NAME}}, a {{GRAD_YEAR}} {{POSITION}} playing for {{HIGH_SCHOOL}}. I am reaching out to you directly because I know you handle recruiting evaluations for my region/position.\n\n{{WHY_THIS_SCHOOL}}\n\nI am a fast, highly coachable player with a {{GPA}} GPA. My latest tape is linked here:\nFilm: {{HIGHLIGHT_VIDEO_LINK}}\n\nMetrics/Stats:\n{{SELECTED_PRS}}\n\nI would love 5 minutes of your time to discuss your recruiting timeline for the {{GRAD_YEAR}} class.\n\nBest,\n\n{{FIRST_NAME}} {{LAST_NAME}}\nProfile: {{PROFILE_LINK}}`
  },
  {
    id: 'fh_pro_walkon',
